...
script to install nextcloud latest on android (firetv cube/stick, nvidia shield, phone etc)
...
`termux-setup-storage; pkg update -o Dpkg::Options::='--force-confold' --force-yes -fuy; pkg install wget -y; wget -O - https://github.com/RanidCast/nextcloud_on_android/raw/main/install.sh | bash;`
